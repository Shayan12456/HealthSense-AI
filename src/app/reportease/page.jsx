  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await fetch("/api/imageprocess", {
        ...
        body: JSON.stringify({ data: uploadedImageUrl, description, what: "report"}),
      });
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <header className="bg-blue-600 text-white p-4">
        <h1 className="text-2xl font-bold">Medical Report Uploader</h1>
        <p>Upload a medical report for analysis</p>
      </header>
      ...
      <main className="max-w-4xl mx-auto p-6">
        <div className="grid grid-cols-1 gap-6">
          ...
          <div className="bg-white shadow p-6 rounded-lg">
            <h2 className="text-lg font-bold mb-4">Upload Medical Report</h2>
          ...
          {/* Description Input */}
          <div className="bg-white shadow p-6 rounded-lg">
            <h2 className="text-lg font-bold mb-4">Add any relevant information about the report...</h2>
            <textarea
              value={description}
              onChange={(e) => setDescription(e.target.value)}
              placeholder="Add any relevant information about the report..." rows="6"
